...
%
%   MAKEFIGS_SUPERFAMILY Makes all figures for 
%
%                          Lilly & Olhede (2012b)
%    "Generalized Morse wavelets as a superfamily of analytic wavelets"
%        IEEE Transactions on Signal Processing 60 (11),  6036--6041.
%
%   Type 'makefigs_superfamily' at the matlab prompt to make all figures for
%   this paper and print them as .eps files into the current directory.
%  
%   Type 'makefigs_superfamily noprint' to supress printing to .eps files.
