function[varargout]=jlab_highlights(varargin)
...
%
%   PACKROWS, PACKCOLS, PACKBOTH.  Are your multiple subplots too far
%   away from each other?  Don't like having to set the axes properties by
%   hand each time?  Check these out.  For example, "packboth(3,4)" will
%   squish your 3 rows and 4 columns so they are right next to each other,
%   removing the redundant x- and y-axes labels.
%   __________________________________________________________________
%   This is part of JLAB --- type 'help jlab' for more information
%   (C) 2011--2012 J.M. Lilly --- type 'help jlab_license' for details
 
if strcmp(varargin{1}, '--t')
    jlab_topten_test,return
end
 
function[]=jlab_topten_test
 
%reporttest('JLAB_TOPTEN',aresame())
