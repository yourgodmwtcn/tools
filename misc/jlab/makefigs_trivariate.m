...
%MAKEFIGS_TRIVARIATE  Makes figures for Lilly (2011).
%
%   MAKEFIGS_TRIVARIATE  Makes all figures for 
%
%                           Lilly (2011)
%           "Modulated Oscillations in Three Dimensions"
%      IEEE Transactions on Signal Processing 59 (12), 5930--5943.
%
%   Type 'makefigs_trivariate' at the matlab prompt to make all figures for
%   this paper and print them as .eps files into the current directory.
%  
%   Type 'makefigs_trivariate noprint' to supress printing to .eps files.
%   __________________________________________________________________
%   This is part of JLAB --- type 'help jlab' for more information
%   (C) 2010--2012 J.M. Lilly --- type 'help jlab_license' for details
...
if strcmp(str,'--f')
     makefigs_trivariate('noprint');return
end
if strcmp(str,'print')
    cd_figures
end
...
for i=1:5
    ...
    title(textstr{i}) 
    text(-3,3,-2.8,['(' setstr(96+numplot(i)) ')'])
end
...
[ombar,upbar]=instfreq(t(2)-t(1),[x y z],2);
