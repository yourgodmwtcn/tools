...
%
% this code loops through vertical position, and so can be slow
%
% NOTE: it allows for non-zero 'S.hc' which is not allowed by the faster
% code 'roms_z'
