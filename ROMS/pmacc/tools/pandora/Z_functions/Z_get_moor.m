...
%
% 6 June 2012 sng included extraction of ocean_time, preallocated some
...
for ttt = 1:NT
    ...
    % make the indices and weightingdimids matrices for the three grids
    ...
    for vv = 1:length(var2get_list)
        ...
        if sum(tf)==1
            ...
            if strcmp(varname,'ocean_time');
                ...
                M.td(ttt) = (ot./(24*60*60))+datenum([yeari,1,1]);
            end
        else
            disp(['** ',var2get,' not found!'])
        end
