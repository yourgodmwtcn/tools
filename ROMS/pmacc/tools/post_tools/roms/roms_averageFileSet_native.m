...
% roms_averageFileSet_native(seriesIn, frameNums, outputFilename);
%                                                    ...,weights);
%															..., outdir);
%
...
% snctools. Otherwise, this code is identical to roms_averageFileSet.m 
% and I checked the output results and they are identical
...
% duplicate the last input file to create a template for the output
%tmp = [seriesIn.dirname 'temp.nc'];
%NOTE that if your output variables changed between files, the code may end
%here with an error, in that case, you may want to copy the first input
