function CTD=Z_FilterCTD2(CTD,FP);
% function CTD=FilterCTD2(CTD,FP);
% Take a CTD structure (req'd fields: yday, z) and filter the fields
% specified in FP.vars in a specified
% range.  The records need to be evenly sampled.
% 10/05 Matthew Alford (MHA)
% Renamed by Parker MacCready (PM) 1/13/2013
